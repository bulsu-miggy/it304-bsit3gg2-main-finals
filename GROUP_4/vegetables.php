...
<body>
    ...
    <section class="bake" id="1">
        ...
        <div class="b-container">
            <div class="box">
            <img src="IMAGES/brocolli.jpg" height="100" width="200"alt="">
                <h3>Fresh Broccoli per kilo</h3>
                <div class="price"> $1.08/-</div>
                <a href="#" class="btn"><i class="fa-sharp fa-solid fa-cart-plus"></i>&emsp;add to cart</a>
            </div>

            <div class="box">
            <img src="IMAGES/cabbage.jpg" height="100" width="200"alt="">
                <h3>Fresh Cabbage per kilo</h3>
                <div class="price"> $0.45/-</div>
                <a href="#" class="btn"><i class="fa-sharp fa-solid fa-cart-plus"></i>&emsp;add to cart</a>
            </div>

            <div class="box">
            <img src="IMAGES/carrot.jpg" height="100" width="200"alt="">
                <h3>Fresh Carrot per kilo</h3>
                <div class="price"> $0.41/-</div>
                <a href="#" class="btn"><i class="fa-sharp fa-solid fa-cart-plus"></i>&emsp;add to cart</a>
            </div>

            <div class="box">
            <img src="IMAGES/radish.jpg" height="100" width="200"alt="">
                <h3>Fresh Radish per Kilo</h3>
                <div class="price"> $0.27/-</div>
                <a href="#" class="btn"><i class="fa-sharp fa-solid fa-cart-plus"></i>&emsp;add to cart</a>
            </div>

            <div class="box">
            <img src="IMAGES/spinach.jpg" height="100" width="200"alt="">
                <h3>Fresh Spinach per kilo</h3>
                <div class="price"> $0.45/- </div>
                <a href="#" class="btn"><i class="fa-sharp fa-solid fa-cart-plus"></i>&emsp;add to cart</a>
            </div>
