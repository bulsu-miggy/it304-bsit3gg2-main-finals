...
<body>
    ...
    <section class="bake" id="1">
        ...
        <div class="b-container">
            <div class="box">
            <img src="IMAGES/almond milk.jpg" height="100" width="200"alt="">
                <h3>Almond Milk</h3>
                <div class="price"> $0.99 - $3.06</div>
                <a href="#" class="btn"><i class="fa-sharp fa-solid fa-cart-plus"></i>&emsp;add to cart</a>
            </div>

            <div class="box">
            <img src="IMAGES/eggs.jpg" height="100" width="200"alt="">
                <h3>Egg large 30pcs</h3>
                <div class="price"> $4.14/-</div>
                <a href="#" class="btn"><i class="fa-sharp fa-solid fa-cart-plus"></i>&emsp;add to cart</a>
            </div>

            <div class="box">
            <img src="IMAGES/mozzarella.jpg" height="100" width="200"alt="">
                <h3>Mozzarella Cheese</h3>
                <div class="price"> $23.39/-</div>
                <a href="#" class="btn"><i class="fa-sharp fa-solid fa-cart-plus"></i>&emsp;add to cart</a>
            </div>

            <div class="box">
            <img src="IMAGES/salted butter.jpg" height="100" width="200"alt="">
                <h3>Salted Butter 10 x 10 g</h3>
                <div class="price"> $1.71</div>
                <a href="#" class="btn"><i class="fa-sharp fa-solid fa-cart-plus"></i>&emsp;add to cart</a>
            </div>

            <div class="box">
            <img src="IMAGES/whipped cream.jpg" height="100" width="200"alt="">
                <h3>Whipped Cream Spray 250 g</h3>
