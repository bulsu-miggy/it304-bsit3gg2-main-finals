...
<body>
    ...
    <section class="bake" id="1">
        ...
        <div class="b-container">
            <div class="box">
            <img src="IMAGES/caramel latte.jpg" height="100" width="200"alt="">
                <h3>Caramel Latte</h3>
                <div class="price"> $2.97 - $3.00</div>
                <a href="#" class="btn"><i class="fa-sharp fa-solid fa-cart-plus"></i>&emsp;add to cart</a>
            </div>

            <div class="box">
            <img src="IMAGES/coke zero.jpg" height="100" width="200"alt="">
                <h3>Coke Zero 200ml x 12 pcs</h3>
                <div class="price"> $2.90/-</div>
                <a href="#" class="btn"><i class="fa-sharp fa-solid fa-cart-plus"></i>&emsp;add to cart</a>
            </div>

            <div class="box">
            <img src="IMAGES/double shot coffee drink.jpg" height="100" width="200"alt="">
                <h3>Double Shot Coffee</h3>
                <div class="price"> $2.97 - $3.00</div>
                <a href="#" class="btn"><i class="fa-sharp fa-solid fa-cart-plus"></i>&emsp;add to cart</a>
            </div>

            <div class="box">
            <img src="IMAGES/jack daniels whiskey.jpg" height="100" width="200"alt="">
                <h3>Jack Daniels Whiskey 1 liter</h3>
                <div class="price"> $40</div>
                <a href="#" class="btn"><i class="fa-sharp fa-solid fa-cart-plus"></i>&emsp;add to cart</a>
            </div>

            <div class="box">
            <img src="IMAGES/yakult.jpg" height="100" width="200"alt="">
                <h3>Yakult pack of 5 bottles</h3>
                <div class="price"> $1.71/- </div>
                <a href="#" class="btn"><i class="fa-sharp fa-solid fa-cart-plus"></i>&emsp;add to cart</a>
            </div>
