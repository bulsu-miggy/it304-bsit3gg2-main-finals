...
<body>
    ...
    <section class="bake" id="1">
        ...
        <div class="b-container">
            <div class="box">
            <img src="IMAGES/apple.jpg" height="100" width="200"alt="">
            ...
            <div class="box">
            <img src="IMAGES/banana.jpg" height="100" width="200"alt="">
                <h3>Fresh Banana per kilo</h3>
                <div class="price"> $1.62/-</div>
                <a href="#" class="btn"><i class="fa-sharp fa-solid fa-cart-plus"></i>&emsp;add to cart</a>
            </div>

            <div class="box">
            <img src="IMAGES/lemon.jpg" height="100" width="200"alt="">
            ...
            <div class="box">
            <img src="IMAGES/mango.jpg" height="100" width="200"alt="">
                <h3>Fresh Mangoes per Kilo</h3>
                <div class="price"> $3.28</div>
                <a href="#" class="btn"><i class="fa-sharp fa-solid fa-cart-plus"></i>&emsp;add to cart</a>
            </div>

            <div class="box">
            <img src="IMAGES/strawberry.jpg" height="100" width="200"alt="">
