...
<body>
    ...
    <section class="bake" id="1">
        ...
        <h1 class="heading">Fresh Meats</h1>

        <div class="b-container">
            <div class="box">
            <img src="IMAGES/bison.jpg" height="100" width="200"alt="">
                <h3>Bison Tenderloin per kilo</h3>
                <div class="price"> $8.10</div>
                <a href="#" class="btn"><i class="fa-sharp fa-solid fa-cart-plus"></i>&emsp;add to cart</a>
            </div>

            <div class="box">
            <img src="IMAGES/chicken.jpg" height="100" width="200"alt="">
                <h3>Fresh Chicken Meat per kilo</h3>
                <div class="price"> $3.06/-</div>
                <a href="#" class="btn"><i class="fa-sharp fa-solid fa-cart-plus"></i>&emsp;add to cart</a>
            </div>

            <div class="box">
            <img src="IMAGES/goat.jpg" height="100" width="200"alt="">
                <h3>Fresh Goat Meat per kilo</h3>
                <div class="price"> $2.70/-</div>
                <a href="#" class="btn"><i class="fa-sharp fa-solid fa-cart-plus"></i>&emsp;add to cart</a>
            </div>

            <div class="box">
            <img src="IMAGES/rabbit.jpg" height="100" width="200"alt="">
                <h3>Fresh Rabbit Meat</h3>
                <div class="price"> $10.81</div>
                <a href="#" class="btn"><i class="fa-sharp fa-solid fa-cart-plus"></i>&emsp;add to cart</a>
            </div>

            <div class="box">
            <img src="IMAGES/turkey.jpg" height="100" width="200"alt="">
                <h3>Fresh Turkey Meat per kilo</h3>
                <div class="price"> $136.94 /- </div>
                <a href="#" class="btn"><i class="fa-sharp fa-solid fa-cart-plus"></i>&emsp;add to cart</a>
            </div>
