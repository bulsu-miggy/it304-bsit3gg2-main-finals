...
<body>
    ...
    <section class="bake" id="1">
        ...
        <h1 class="heading">Frozen Goods</h1>

        <div class="b-container">
            <div class="box">
            <img src="IMAGES/bacon.jpg" height="100" width="200"alt="">
                <h3>Bacon</h3>
            ...
            <div class="box">
            <img src="IMAGES/chicken nuggets.jpg" height="100" width="200"alt="">
            ...
            <div class="box">
            <img src="IMAGES/hotdog.jpg" height="100" width="200"alt="">
                <h3>Hotdog</h3>
            ...
            <div class="box">
            <img src="IMAGES/skinless longganisa.jpg" height="100" width="200"alt="">
                <h3>Skinless Longganisa</h3>
                <div class="price"> $4.23/-</div>
                <a href="#" class="btn"><i class="fa-sharp fa-solid fa-cart-plus"></i>&emsp;add to cart</a>
            </div>

            <div class="box">
            <img src="IMAGES/tocino.jpg" height="100" width="200"alt="">
                <h3>Pork Tocino</h3>
