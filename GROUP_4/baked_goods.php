...
<body>
    ...
    <section class="bake" id="1">
        ...
        <h1 class="heading">Baked Goods</h1>

        <div class="b-container">
            <div class="box">
            <img src="IMAGES/baked mac.jpg" height="100" width="200"alt="">
                <h3>Baked Mac</h3>
            ...
            <div class="box">
            <img src="IMAGES/chocolate cupcake.jpg" height="100" width="200"alt="">
                <h3>Chocolate cupcake</h3>
                <div class="price"> $2.16/-</div>
                <a href="#" class="btn"><i class="fa-sharp fa-solid fa-cart-plus"></i>&emsp;add to cart</a>
            </div>

            <div class="box">
            <img src="IMAGES/cookies.jpg" height="100" width="200"alt="">
                <h3>Cookies</h3>
                <div class="price"> $2.02/-</div>
                <a href="#" class="btn"><i class="fa-sharp fa-solid fa-cart-plus"></i>&emsp;add to cart</a>
            </div>

            <div class="box">
            <img src="IMAGES/cupcake.jpg" height="100" width="200"alt="">
                <h3>Cupcakes</h3>
                <div class="price"> $2.00 - $2.05</div>
                <a href="#" class="btn"><i class="fa-sharp fa-solid fa-cart-plus"></i>&emsp;add to cart</a>
            </div>

            <div class="box">
            <img src="IMAGES/doughnut.jpg" height="100" width="200"alt="">
                <h3>Doughnut</h3>
                <div class="price"> $4.55 - $4.57</div>
                <a href="#" class="btn"><i class="fa-sharp fa-solid fa-cart-plus"></i>&emsp;add to cart</a>
            </div>
